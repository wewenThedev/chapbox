    ...
    return Scaffold(
      ...
      items: [
        BottomNavigationBarItem(
          icon: Icon(_selectedIndex == 0 ? Iconsax.home : Iconsax.home /*Icons.home_filled*/),
          label: 'Accueil',
        ),
        /*BottomNavigationBarItem(
        ...
        BottomNavigationBarItem(
          icon: Icon(_selectedIndex == 1 ?  Iconsax.shopping_cart : Iconsax.shopping_cart_copy /*LineIcons.shoppingCart : LineIcons.shoppingCart Icons.shopping_cart*/),
          label: 'Panier',
        ),
        BottomNavigationBarItem(
          icon: Icon(_selectedIndex == 2 ? Iconsax.shopping_bag : Iconsax.shopping_bag_copy /*Iconsax.ship*/ /*LineIcons.search//Icons.search*/),
          label: 'Commandes',
        ),
        BottomNavigationBarItem(
          icon: Icon(_selectedIndex == 3 ? Iconsax.setting : Iconsax.setting /*LineIcons.byName('gear-1') //Icons.settings*/),
          label: 'Paramètres',
        ),
      ],
    ),
